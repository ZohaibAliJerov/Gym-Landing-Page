...
>
  <div class="flex relative">
    <!-- <div
      class={"absolute rounded-full w-fullaspect-square hidden md:grid place-items-center h-4 top-0" +
        (index % 2 === 0 ? "mr-10" : "left-0 -ml-8 -translate-x-1/2")}
    >
      <div class="rounded-full bg-slate-950 aspect-square h-2 hidden"></div>
    </div> -->
